...
![Screenshot of Package Anatomy Template](https://raw.githubusercontent.com/jthomasmock/pkg-building/master/images/rstudio-create-pkg.gif)
...
```{r}
### INSERT:  starwars data set coding chunks
# devtools::install() 
```
